                     ...
                     <table class="table align-middle datatable dt-responsive table-check nowrap" style="border-collapse: collapse; border-spacing: 0 8px; width: 100%;">
                         ...
                         <tbody>
                             <tr>
                                 ...
                                 <td>
                                     <img src="{{ URL::asset('admin/assets/images/users/avatar-2.jpg') }}" alt="" class="avatar-sm rounded-circle me-2">
                             ...
                             <tr>
                                 ...
                                 <td>
                                     <img src="{{ URL::asset('admin/assets/images/users/avatar-1.jpg') }}" alt="" class="avatar-sm rounded-circle me-2">
                             ...
                             <tr>
                                 ...
                                 <td>
                                     <img src="{{ URL::asset('admin/assets/images/users/avatar-3.jpg') }}" alt="" class="avatar-sm rounded-circle me-2">
                             ...
                             <tr>
                                 ...
                                 <td>
                                     <img src="{{ URL::asset('admin/assets/images/users/avatar-6.jpg') }}" alt="" class="avatar-sm rounded-circle me-2">
                             ...
                             <tr>
                                 ...
                                 <td>
                                     <img src="{{ URL::asset('admin/assets/images/users/avatar-8.jpg') }}" alt="" class="avatar-sm rounded-circle me-2">
                             ...
                             <tr>
                                 ...
                                 <td>
                                     <img src="{{ URL::asset('admin/assets/images/users/avatar-9.jpg') }}" alt="" class="avatar-sm rounded-circle me-2">
                             ...
                             <tr>
                                 ...
                                 <td>
                                     <img src="{{ URL::asset('admin/assets/images/users/avatar-4.jpg') }}" alt="" class="avatar-sm rounded-circle me-2">
